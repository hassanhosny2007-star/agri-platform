...
const AgroNexLayout = (() => {
  ...
  const NAV_ITEMS = [
    ...
    { key: 'radar', href: 'radar.html', icon: '📡', roles: 'all', permKey: 'can_view_radar' },
    { key: 'demand-forecast', href: 'demand-forecast.html', icon: '📊', roles: 'all', permKey: 'can_view_demand_forecast' },
    { key: 'earth-pulse', href: 'earth-pulse.html', icon: '💓', roles: 'all', permKey: 'can_view_earth_pulse' },
    { key: 'war-room', href: 'war-room.html', icon: '🚨', roles: 'all', permKey: 'can_view_war_room' },
    ...
    { key: 'my-clients', href: 'my-clients.html', icon: '👥', roles: 'all', permKey: 'can_manage_clients' },
    { key: 'my-performance', href: 'my-performance.html', icon: '📈', roles: 'all', permKey: 'can_manage_clients' },
    { key: 'my-planner', href: 'my-planner.html', icon: '🗂️', roles: 'all', permKey: 'can_manage_clients' },
    { key: 'agricultural-calendar', href: 'agricultural-calendar.html', icon: '📅', roles: 'all' },
    { key: 'reviews', href: 'reviews.html', icon: '⭐', roles: 'all', permKey: 'can_rate_platform' },
    { key: 'notification-settings', href: 'notification-settings.html', icon: '🔔', roles: 'all' },
