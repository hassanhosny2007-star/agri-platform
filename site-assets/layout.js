  ...
  const I18N = {
    ...
    en: {
      nav: {
        ...
        'mix-checker': 'Pesticide & Fertilizer Mixing', substances: 'Active Substances Guide', 'crop-prices': 'Crop Prices', 'disease-risk': 'Disease Risk Analysis', 'weather-history': 'Weather History', 'disease-map': 'Disease Map', 'crops-map': 'Crops Map', radar: 'AgroNex Radar', 'demand-forecast': 'Demand Forecast', 'earth-pulse': 'Earth Pulse', 'war-room': 'War Room', marketplace: 'Online Marketplace', 'my-products': 'My Products', 'my-profile': 'My Profile',
